...
*Bring your CATIA graph tree in order.*

This app does the following for you:

- order the CATIA graph tree by source alphabetically (made parts first, the bought)
